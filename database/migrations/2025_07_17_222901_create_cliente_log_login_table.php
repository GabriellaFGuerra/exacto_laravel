...
return new class extends Migration
{
    ...
    {
        Schema::create('cliente_log_login', function (Blueprint $table) {
            $table->integer('log_id', true);
            $table->integer('log_usuario')->nullable()->index('fk_cliente_log_usuario');
    ...
    {
        Schema::dropIfExists('cliente_log_login');
    }
};
