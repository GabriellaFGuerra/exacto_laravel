    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-white leading-tight">
                {{ __('Editar Fornecedor') }} - {{ $provider->name }}
            </h2>
                    ...
                    <form method="POST" action="{{ route('providers.update', $provider) }}">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $provider->cnpj) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="zip_code" id="zip_code"
                                        value="{{ old('zip_code', $provider->zip_code) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="city" id="city" value="{{ old('city', $provider->city) }}"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('city')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="observation" id="observation" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                placeholder="Observações sobre o fornecedor...">{{ old('observation', $provider->observation) }}</textarea>
                            @error('observation')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
